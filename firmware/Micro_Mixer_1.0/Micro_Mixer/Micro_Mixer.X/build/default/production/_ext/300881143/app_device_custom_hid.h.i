# 1 "../demo_src/app_device_custom_hid.h.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../demo_src/app_device_custom_hid.h.c" 2
# 21 "../demo_src/app_device_custom_hid.h.c"
# 1 "../usb/inc\\usb.h" 1
# 45 "../usb/inc\\usb.h"
# 1 "../demo_src\\usb_config.h" 1
# 27 "../demo_src\\usb_config.h"
# 1 "../usb/inc\\usb_ch9.h" 1
# 42 "../usb/inc\\usb_ch9.h"
...
# 33 "../usb/inc/usb_hal_pic18.h" 2
# 48 "../usb/inc/usb_hal_pic18.h"
...
# 51 "../usb/inc\\usb.h" 2
# 21 "../demo_src/app_device_custom_hid.h.c" 2

# 1 "../usb/inc\\usb_device_hid.h" 1
# 98 "../usb/inc\\usb_device_hid.h"
void USBCheckHIDRequest(void);
# 280 "../usb/inc\\usb_device_hid.h"
...
# 22 "../demo_src/app_device_custom_hid.h.c" 2
...
# 23 "../demo_src/app_device_custom_hid.h.c" 2
...
# 1 ".\\system.h" 1
# 27 ".\\system.h"
# 1 "../demo_src\\fixed_address_memory.h" 1
# 27 ".\\system.h" 2
...
# 27 "../demo_src/app_device_custom_hid.h.c" 2
# 45 "../demo_src/app_device_custom_hid.h.c"
...
# 55 "../demo_src/app_device_custom_hid.h.c"
...
# 84 "../demo_src/app_device_custom_hid.h.c"
...
# 111 "../demo_src/app_device_custom_hid.h.c"
void MixerTasks()
{
        ...
        switch(ReceivedDataBuffer[0])
        {
            ...
            case COMMAND_RELAY_ALL_INFO:
                ...
                if(!((USBInHandle != 0x0000) && ((*(volatile uint8_t*)USBInHandle & 0x80) != 0x00)))
                {
                    ...
                    readSliders(&ToSendDataBuffer[1]);
# 164 "../demo_src/app_device_custom_hid.h.c"
                    USBInHandle = USBTransferOnePacket(1,1,(uint8_t*)&ToSendDataBuffer[0],sizeof(ToSendDataBuffer));
                }
                break;
        }
...
void scanRows(void){
    PORTC = 1 << 1;
    keysPressed |= (PORTBbits.RB5 << 0) | (PORTBbits.RB4 << 1) | (PORTBbits.RB3 << 2) | (PORTBbits.RB2 << 3);
    PORTC = 1 << 2;
    keysPressed |= (PORTBbits.RB5 << 5) | (PORTBbits.RB4 << 6) | (PORTBbits.RB3 << 7);
    PORTC = 0;
}
